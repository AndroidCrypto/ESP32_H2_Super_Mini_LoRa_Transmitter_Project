...
- the final project: "**ESP32-H2 Super Mini with environment sensor, battery voltage reading, e-paper display, and LoRa transmission module (the complete project)**": https://medium.com/@androidcrypto/esp32-h2-super-mini-with-environment-sensor-battery-voltage-reading-e-paper-display-and-lora-80678ed47842
