/*
  ...
  If the board doesn't supports measuring of the battery voltage, you need
  an external unit like the MAX17043 meter.        

  08.07.2026 V01 Initial programming, moved code from MAX17403_METER to here
*/

// This is activated when defining BATTERY_VOLTAGE_ADC_PIN 1

#ifndef IS_BATTERY_MANAGEMENT
...
// This value depends on the integrated voltage divider on the board
const float BATTERY_VOLTAGE_DIVIDER = 238.7;

// please change these constants with care
...
// these data remain in rtc memory even after deep sleep
...
// methods for integrated battery voltage reading
...
// this is responsible for checking the thresholds for upper- and undervoltage
void checkVoltageThresholds() {
  if (batteryVoltage > BATTERY_UPPERVOLTAGE_DETECTOR_THRESHOLD) {
    // reset the counter
    batteryUndervoltageDetectorCount = 0;
#ifdef INCLUDE_SERIAL_MONITOR
